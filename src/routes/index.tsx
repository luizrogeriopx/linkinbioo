...
function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen w-full max-w-full flex-col overflow-x-hidden selection:bg-primary selection:text-primary-foreground">
      {/* 1. Header / Navbar */}
      ...
      {/* 2. Hero Section */}
      <section className="relative w-full overflow-hidden px-4 pb-20 pt-12 sm:px-6 lg:pb-32 lg:pt-20">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            >
              ...
              <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center lg:justify-start">
                ...
                <Button size="lg" variant="outline" asChild className="h-auto min-h-12 sm:h-13 w-full sm:w-auto rounded-2xl border-glass-border bg-glass px-4 py-3 sm:px-6 text-sm sm:text-base font-semibold text-center">
                  <RouterLink to="/$username" params={{ username: "luizrogeriopaixao" }}>
                    <ExternalLink className="mr-2 size-4 shrink-0" />
                    <span>Ver Exemplo Real (@luizrogeriopaixao)</span>
                  </RouterLink>
                </Button>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-2 text-xs text-muted-foreground lg:justify-start">
                <span className="flex items-center gap-1.5">
                  <ShieldCheck className="size-4 text-emerald-400 shrink-0" /> 7 dias de garantia
                </span>
                <span className="flex items-center gap-1.5">
                  <Zap className="size-4 text-amber-400 shrink-0" /> Ativação imediata
                </span>
                <span className="flex items-center gap-1.5">
                  <Lock className="size-4 text-primary shrink-0" /> Cancele quando quiser
                </span>
              </div>
            </motion.div>
      ...
      <section className="w-full overflow-hidden border-y border-glass-border bg-card/30 py-10 backdrop-blur-md">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-4 px-4 text-center sm:gap-8 sm:px-6 md:grid-cols-4">
          <div>
      ...
      {/* 4. Features Section */}
      <section id="recursos" className="w-full overflow-hidden px-4 py-20 sm:px-6 lg:py-28">
        <div className="mx-auto max-w-6xl space-y-16">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <FeatureCard
              icon={<Layers className="size-6 text-primary shrink-0" />}
            ...
            />
            <FeatureCard
              icon={<BarChart3 className="size-6 text-accent shrink-0" />}
            ...
            />
            <FeatureCard
              icon={<Sparkles className="size-6 text-amber-400 shrink-0" />}
            ...
            />
            <FeatureCard
              icon={<QrCode className="size-6 text-emerald-400 shrink-0" />}
            ...
            />
            <FeatureCard
              icon={<Search className="size-6 text-sky-400 shrink-0" />}
            ...
            />
            <FeatureCard
              icon={<Globe className="size-6 text-purple-400 shrink-0" />}
      ...
      {/* 5. Pricing Section */}
      <section id="precos" className="relative w-full overflow-hidden px-4 py-20 sm:px-6 lg:py-28">
        <div className="mx-auto max-w-6xl space-y-12">
          ...
          <div className="mx-auto grid max-w-4xl gap-8 px-2 sm:px-0 lg:grid-cols-2">
            ...
            <div className="relative flex flex-col justify-between rounded-3xl border border-glass-border bg-card/70 p-6 sm:p-8 shadow-xl backdrop-blur-md transition-all hover:border-primary/40">
              ...
              <div className="mt-8">
                <Button asChild size="lg" variant="outline" className="h-auto min-h-12 sm:h-13 w-full rounded-2xl border-primary/40 py-3 px-4 text-sm sm:text-base font-bold shadow-md hover:bg-primary hover:text-primary-foreground text-center">
                  <RouterLink to="/auth">
                    <span>Começar 7 Dias Grátis</span>
                    <ArrowRight className="ml-2 size-4 sm:size-5 shrink-0" />
                  </RouterLink>
            ...
            <div className="relative flex flex-col justify-between rounded-3xl border-2 border-primary/60 bg-card p-6 sm:p-8 shadow-2xl shadow-primary/15 transition-all">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 max-w-[90%] truncate rounded-full bg-gradient-to-r from-primary to-accent px-3 sm:px-4 py-1 text-[11px] sm:text-xs font-bold uppercase tracking-wider text-white shadow-md">
              ...
              <div className="mt-8">
                <Button asChild size="lg" className="h-auto min-h-12 sm:h-13 w-full rounded-2xl py-3 px-4 text-sm sm:text-base font-bold shadow-lg shadow-primary/30 text-center">
                  <RouterLink to="/auth">
                    <span>Assinar Agora por {SAAS_CONFIG.formattedPrice}/mês</span>
                    <ArrowRight className="ml-2 size-4 sm:size-5 shrink-0" />
                  </RouterLink>
                </Button>
                <p className="mt-3 text-center text-xs text-muted-foreground">
      ...
      {/* 6. FAQ Section */}
      <section id="faq" className="w-full overflow-hidden px-4 py-20 sm:px-6 lg:py-28">
      ...
      <section className="w-full overflow-hidden px-4 pb-20 sm:px-6">
        <div className="mx-auto max-w-5xl rounded-3xl bg-gradient-to-br from-primary/90 via-primary to-accent p-6 sm:p-14 text-center text-primary-foreground shadow-2xl">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Button asChild size="lg" variant="secondary" className="h-auto min-h-12 py-3.5 px-6 sm:px-8 text-sm sm:text-base font-bold shadow-xl text-center">
              <RouterLink to="/auth">
      ...
      {/* 8. Footer */}
      <footer className="w-full overflow-hidden border-t border-glass-border bg-background py-10">
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="glass rounded-3xl border-glass-border p-6 transition-transform hover:-translate-y-1">
      <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl bg-secondary">{icon}</div>
